#
# Script that defines the Stan model meta data for the gompertz-OD-calibration model and function which creates a Stan data list.
#
...
#
# function that arranges data in format stan model got data in
#
...
params <- c("tau", "delta_tilde", "beta", "sigma_meas", "L", "basal")  #parameters in the model - needs to be assigned as params
#
# population parameters of the model
# to be called by tidybayes::gather_draws
#
pop_params2lang <- "cbind(tau, delta_tilde, beta, sigma_meas, L, basal)"
