#
# Script that defines the Stan model meta data for the exponential model with no delay and function which creates a Stan data list.
#
...
params <- c("basal", "sigma_meas", "f_0", "beta")  #parameters in the model - needs to be assigned as params
#
# population parameters of the model
# to be called by tidybayes::gather_draws
#
pop_params2lang <- "cbind(sigma_meas, basal, f_0, beta)"
