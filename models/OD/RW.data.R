#
# Script that defines the Stan model meta data for the RW model and function which creates a Stan data list.
# To be called into any of the 01_prior_red.R & 02_post_pred.R
#
get_stan_data <- function(dat, run_likelihood = NULL){
  #
  # takes tibble of data and returns list that will be used as the Stan data
  # data must match the order of the data block in the corresponding model models/RW.stan
  #
...
params <- c("sigma")  #parameters in the model - needs to be assigned as params
#
