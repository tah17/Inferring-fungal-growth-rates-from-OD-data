#
# Script that defines the Stan model meta data for logistic-OD-calibration model with no delay model 
#
...
params <- c("delta_tilde", "beta", "sigma_meas", "L", "basal")  #parameters in the model - needs to be assigned as params
#
# population parameters of the model
# to be called by tidybayes::gather_draws
#
pop_params2lang <- "cbind(delta_tilde, beta, sigma_meas, L, basal)"
