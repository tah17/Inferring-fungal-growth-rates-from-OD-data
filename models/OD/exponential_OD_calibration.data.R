#
# Script that defines the Stan model meta data for the latent var exponential model and function which creates a Stan data list.
#
...
params <- c("delta_tilde", "basal", "tau", "beta", "sigma_meas")  #parameters in the model - needs to be assigned as params
#
# population parameters of the model
# to be called by tidybayes::gather_draws
#
pop_params2lang <- "cbind(basal, delta_tilde, tau, beta, sigma_meas)"
